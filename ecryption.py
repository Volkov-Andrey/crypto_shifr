# Функция для размножения ключа до длины сообщенияAdd commentMore actions
...
# Основная часть программыAdd commentMore actions
if __name__ == "__main__":
 # Запрашиваем у пользователя ключ и текст для шифрованияAdd commentMore actions
    key = input("Введите ключ для шифрования (строка): ")
    message = input("Введите текст для шифрования: ")

    encrypted_text = encrypt(key, message)Add commentMore actions
    print("\nЗашифрованный текст:\n", encrypted_text)
